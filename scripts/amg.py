...
parser.add_argument(
    "--output",
    type=str,
    default='/home/david/PycharmProjects/SAM-Not-Perfect/sam_output/vit_h',
...
parser.add_argument(
    "--checkpoint",
    type=str,
    default='/home/david/PycharmProjects/segment-anything-main/model_ck/sam_vit_h_4b8939.pth',
