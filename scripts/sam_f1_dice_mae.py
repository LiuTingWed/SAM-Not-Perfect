...
def find_best_F1(prediction_folder, ground_truth_file, folder):
...
def main():
    ...
    for folder in tqdm(folders, desc="Processing folders"):
        ...
        best_dice, best_f_measure, best_prediction_file, best_mae = find_best_F1(prediction_folder, ground_truth_file, folder)
    ...
    logging.info(f"Average best F1 {average_f1_measure:.4f} Average best Dice {average_dice:.4f} Average best MAE {average_mae_measure:.4f} number: {folder_count}")
